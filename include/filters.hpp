...
namespace jpeg2000 {
     ...
     * The Haar process needs even input signal.
     */
namespace filters {
     ...
     * @param _h0: Low pass filter. Need to be odd
     * @param _h1: Low pass filter. Need to be odd
     */
    ...
    /**
     * Operates Haar 9/7 process.
     */
    Signal1D analyseHaar97(const Signal1D& signal);
    /**
     * Operates Haar 9/7 inverse process.
     */
